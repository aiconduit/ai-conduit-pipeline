...
NARRATION_DATA["html-anything-launch"] = {
    "chunks": [
        ...
        "これまでHTMLを動画にするには専門的なツールと多くの時間が必要でした。",
        "html-anythingを使えばAIエージェントがHTMLを自動生成して動画にできます。",
        "インストールはnpxコマンド一発で完了します。",
        "追加設定は一切不要です。",
        "Claude CodeもCursorもGeminiも、9つの主要AIエージェントに全対応しています。",
        "テンプレートを選んでAIに指示するだけで動画が自動生成されます。",
        "HyperFramesと組み合わせればShortsへの完全自動投稿も実現できます。",
        "こんなに簡単に動画が作れる時代になりました。",
        "コメントにAI Conduitと書いて、いいねと保存もお願いします。",
        "概要欄のリンクからテンプレートを無料で受け取れます。",
    ],
    "rate": "+15%",
