...
MAX_CHARS = 20  # 1行最大20文字（fontsize=52px、1080px幅に収まる）
...
for timing, text in entries:
    ...
    for i, line in enumerate(lines):
        ...
        f = f"drawtext=text='{safe}'{font_opt}:x=20:y=1120:fontsize=52:fontcolor=white:borderw=3:bordercolor=black:enable='between(t,{ls:.3f},{le:.3f})'"
        filters.append(f)
